...
{
    // AssetBundleのベースURL
    //public string remoteManifestURL = "http://keycert.site/test/Unknown";
    public string remoteManifestURL = "http://14.52.96.94:4600/Unknown";
    
    public string localManifestPath = "Unknown";
    // ローカル(StreamingAssets)のAssetBundleをロードするかどうか
    public bool isLocal = true;
    // ダウンロード対象のアセットバンドル
    public string[] downloadAssetBundles = { "cube" };
